...
basic_settings = {
    "ZH_CN": {
        ...
        "show_startup_window": {
            "name": "显示启动画面",
            "description": "设置软件启动时是否显示启动欢迎画面",
            "switchbutton_name": {"enable": "显示", "disable": "不显示"},
        },
        "export_diagnostic_data": {
            "name": "导出诊断数据",
            "description": "退出软件时导出诊断信息用于问题排查",
            "pushbutton_name": "导出诊断数据",
        },
        "export_settings": {
            "name": "导出设置",
            "description": "将当前设置导出为配置文件以便备份或迁移",
            "pushbutton_name": "导出设置",
        },
        "import_settings": {
            "name": "导入设置",
            "description": "从配置文件导入设置覆盖当前配置",
        ...
        "dpiScale": {
            "name": "DPI缩放",
            "description": "调整软件界面缩放比例（需要重启软件生效）",
            "combo_items": ["100%", "125%", "150%", "175%", "200%", "自动"],
        },
        "font": {
            "name": "字体",
            "description": "设置软件界面显示字体（需要重启软件生效）",
        },
        "theme": {
            "name": "主题模式",
