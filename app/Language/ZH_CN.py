ZH_CN = {
    ...
    "home": {"title": {"name": "主页", "description": "软件主页"}},
    "basic_settings": {
    ...
    "list_management": {
        "title": {"name": "名单管理", "description": "软件名单管理页面"}
    },
    "roll_call_list": {
    ...
    "custom_draw_list": {"title": {"name": "自定义抽签", "description": "自定义抽签"}},
    "lottery_list": {
    ...
    "extraction_settings": {"title": {"name": "抽取设置", "description": "抽取设置"}},
    "roll_call_settings": {
    ...
    "custom_draw_settings": {
        "title": {"name": "自定义抽设置", "description": "自定义抽设置"}
    },
    "lottery_settings": {
    ...
    "notification_settings": {"title": {"name": "通知设置", "description": "通知设置"}},
    ...
    "quick_draw_notification_settings": {
        "title": {"name": "闪抽通知设置", "description": "闪抽通知设置"},
        "basic_settings": {"name": "基础设置", "description": "基础设置"},
        "window_mode": {
            "name": "窗口模式",
    ...
    "instant_draw_notification_settings": {
        "title": {"name": "即抽通知设置", "description": "即抽通知设置"},
        "basic_settings": {"name": "基础设置", "description": "基础设置"},
        "window_mode": {
            "name": "窗口模式",
    ...
    "lottery_notification_settings": {
        "title": {"name": "抽奖通知设置", "description": "抽奖通知设置"},
        "basic_settings": {"name": "基础设置", "description": "基础设置"},
        "window_mode": {
            "name": "窗口模式",
    ...
    "safety_settings": {"title": {"name": "安全设置", "description": "安全设置"}},
    ...
    "advanced_safety_settings": {
        "title": {"name": "进阶安全设置", "description": "进阶安全设置"},
        "strong_protection": {
            "name": "强力防删除设置",
            "description": "强力防删除功能设置",
        },
        "data_encryption": {"name": "数据加密设置", "description": "数据加密功能设置"},
        ...
        "encryption_strong_mode": {
            ...
            "combo_items": ["仅软件目录备份", "软件目录+系统缓存目录备份"],
        },
    ...
    "custom_settings": {"title": {"name": "个性设置", "description": "个性设置"}},
    "page_management": {
        "title": {"name": "页面管理", "description": "页面管理设置"},
        "roll_call": {"name": "点名设置", "description": "点名设置"},
        "lottery": {"name": "抽奖设置", "description": "抽奖设置"},
        "roll_call_method": {
            "name": "点名控制面板位置",
    ...
    "voice_settings": {"title": {"name": "语音设置", "description": "语音设置页面"}},
    ...
    "history": {"title": {"name": "历史记录", "description": "历史记录设置"}},
    "history_management": {
    ...
    "more_settings": {
        "title": {"name": "更多设置", "description": "更多设置"},
    },
    "debug": {"title": {"name": "调试设置", "description": "调试设置"}},
    "about": {
        "title": {"name": "关于", "description": "软件关于页面"},
        "github": {"name": "Github", "description": "访问项目仓库"},
        "bilibili": {
            "name": "Bilibili",
        ...
        "website": {"name": "SecRandom 官网", "description": "访问 SecRandom 软件官网"},
        "channel": {
            "name": "更新通道",
            "description": "选择 SecRandom 软件更新通道",
            "combo_items": ["正式版本", "测试版本"],
        },
        "copyright": {"name": "版权", "description": "SecRandom 遵循 GPL-3.0 协议"},
