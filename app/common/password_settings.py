...
class password_SettingsCard(GroupHeaderCardWidget):
    def __init__(self, parent=None):
        ...
        self.addGroup(get_theme_icon("ic_fluent_password_20_filled"), "设置/修改密码", "设置/修改SecRadnom的密码", self.set_password_button)
        ...
        self.addGroup(get_theme_icon("ic_fluent_usb_20_filled"), "U盘认证", "启用U盘作为认证设备", self.usb_auth_switch)
        self.addGroup(get_theme_icon("ic_fluent_usb_plug_20_filled"), "绑定U盘", "绑定U盘作为认证设备", self.bind_usb_button)
        self.addGroup(get_theme_icon("ic_fluent_usb_disconnect_20_filled"), "解绑U盘", "解绑当前U盘", self.unbind_usb_button)
