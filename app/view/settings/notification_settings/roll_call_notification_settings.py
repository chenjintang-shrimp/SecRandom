...
class window_mode(GroupHeaderCardWidget):
    def __init__(self, parent=None):
        ...
        if readme_settings("roll_call_notification_settings", "enabled_monitor") == "OFF":
        ...
        self.enabled_monitor_combo_box.setCurrentText(readme_settings("roll_call_notification_settings", "enabled_monitor"))
        ...
        self.addGroup(get_theme_icon("ic_fluent_window_text_20_filled"), 
                        get_content_name("roll_call_notification_settings", "enabled_monitor"), get_content_description("roll_call_notification_settings", "enabled_monitor"), self.enabled_monitor_combo_box)
...
class floating_window_settings(GroupHeaderCardWidget):
    def __init__(self, parent=None):
        ...
        # 窗口位置
        self.window_position_combo_box = ComboBox()
        self.window_position_combo_box.addItems(get_content_combo_name("roll_call_notification_settings", "floating_window_position"))
        self.window_position_combo_box.setCurrentIndex(readme_settings("roll_call_notification_settings", "floating_window_position"))
        ...
        self.horizontal_offset_spin_spinbox.setRange(-25600, 25600)
        self.horizontal_offset_spin_spinbox.setSuffix("px")
        self.horizontal_offset_spin_spinbox.setValue(readme_settings("roll_call_notification_settings", "floating_window_horizontal_offset"))
        ...
        self.vertical_offset_spin_spinbox.setRange(-25600, 25600)
        self.vertical_offset_spin_spinbox.setSuffix("px")
        self.vertical_offset_spin_spinbox.setValue(readme_settings("roll_call_notification_settings", "floating_window_vertical_offset"))
        ...
        self.enabled_monitor_combo_box = ComboBox()
        self.enabled_monitor_combo_box.addItems(self.get_monitor_list())
        if readme_settings("roll_call_notification_settings", "floating_window_enabled_monitor") == "OFF":
            self.enabled_monitor_combo_box.setCurrentText(self.get_monitor_list()[0])
        ...
        self.enabled_monitor_combo_box.setCurrentText(readme_settings("roll_call_notification_settings", "floating_window_enabled_monitor"))
        ...
        # 添加设置项到分组
        self.addGroup(get_theme_icon("ic_fluent_window_text_20_filled"), 
                        get_content_name("roll_call_notification_settings", "floating_window_enabled_monitor"), get_content_description("roll_call_notification_settings", "floating_window_enabled_monitor"), self.enabled_monitor_combo_box)
        self.addGroup(get_theme_icon("ic_fluent_position_to_back_20_filled"), 
                        get_content_name("roll_call_notification_settings", "floating_window_position"), get_content_description("roll_call_notification_settings", "floating_window_position"), self.window_position_combo_box)
        self.addGroup(get_theme_icon("ic_fluent_align_stretch_horizontal_20_filled"), 
                        get_content_name("roll_call_notification_settings", "floating_window_horizontal_offset"), get_content_description("roll_call_notification_settings", "floating_window_horizontal_offset"), self.horizontal_offset_spin_spinbox)
        self.addGroup(get_theme_icon("ic_fluent_align_stretch_vertical_20_filled"), 
                        get_content_name("roll_call_notification_settings", "floating_window_vertical_offset"), get_content_description("roll_call_notification_settings", "floating_window_vertical_offset"), self.vertical_offset_spin_spinbox)
        self.addGroup(get_theme_icon("ic_fluent_transparency_square_20_filled"), 
