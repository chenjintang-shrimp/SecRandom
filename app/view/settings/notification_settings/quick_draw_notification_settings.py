...
class window_mode(GroupHeaderCardWidget):
    def __init__(self, parent=None):
        ...
        self.auto_close_time_spinbox.setValue(
            readme_settings_async("quick_draw_notification_settings", "auto_close_time")
        )
        ...
        self.addGroup(
            ...
            get_content_name_async("quick_draw_notification_settings", "auto_close_time"),
            get_content_description_async(
                "quick_draw_notification_settings", "auto_close_time"
            ),
...
class floating_window_settings(GroupHeaderCardWidget):
    def __init__(self, parent=None):
        ...
        self.floating_window_auto_close_time_spinbox.setValue(
            readme_settings_async("quick_draw_notification_settings", "floating_window_auto_close_time")
        )
