...
class page_management_roll_call(GroupHeaderCardWidget):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setTitle(get_content_name("page_management", "roll_call"))
        self.setBorderRadius(8)

        # 点名控制面板位置下拉框
        self.roll_call_method_combo = ComboBox()
        self.roll_call_method_combo.addItems(get_content_combo_name("page_management", "roll_call_method"))
        ...
        self.show_name_button_switch.setOffText(get_content_switchbutton_name("page_management", "show_name", "disable"))
        self.show_name_button_switch.setOnText(get_content_switchbutton_name("page_management", "show_name", "enable"))
        ...
        self.reset_roll_call_button_switch.setOffText(get_content_switchbutton_name("page_management", "reset_roll_call", "disable"))
        self.reset_roll_call_button_switch.setOnText(get_content_switchbutton_name("page_management", "reset_roll_call", "enable"))
        ...
        self.roll_call_quantity_control_switch.setOffText(get_content_switchbutton_name("page_management", "roll_call_quantity_control", "disable"))
        self.roll_call_quantity_control_switch.setOnText(get_content_switchbutton_name("page_management", "roll_call_quantity_control", "enable"))
        ...
        self.roll_call_start_button_switch.setOffText(get_content_switchbutton_name("page_management", "roll_call_start_button", "disable"))
        self.roll_call_start_button_switch.setOnText(get_content_switchbutton_name("page_management", "roll_call_start_button", "enable"))
        ...
        self.roll_call_list_combo_switch.setOffText(get_content_switchbutton_name("page_management", "roll_call_list", "disable"))
        self.roll_call_list_combo_switch.setOnText(get_content_switchbutton_name("page_management", "roll_call_list", "enable"))
        ...
        self.roll_call_range_combo_switch.setOffText(get_content_switchbutton_name("page_management", "roll_call_range", "disable"))
        self.roll_call_range_combo_switch.setOnText(get_content_switchbutton_name("page_management", "roll_call_range", "enable"))
        ...
        self.roll_call_gender_combo_switch.setOffText(get_content_switchbutton_name("page_management", "roll_call_gender", "disable"))
        self.roll_call_gender_combo_switch.setOnText(get_content_switchbutton_name("page_management", "roll_call_gender", "enable"))
        ...
        self.roll_call_quantity_label_switch.setOffText(get_content_switchbutton_name("page_management", "roll_call_quantity_label", "disable"))
        self.roll_call_quantity_label_switch.setOnText(get_content_switchbutton_name("page_management", "roll_call_quantity_label", "enable"))
...
class page_management_lottery(GroupHeaderCardWidget):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setTitle(get_content_name("page_management", "lottery"))
        self.setBorderRadius(8)

        # 抽奖控制面板位置下拉框
        self.lottery_method_combo = ComboBox()
        self.lottery_method_combo.addItems(get_content_combo_name("page_management", "lottery_method"))
        ...
        self.show_lottery_name_button_switch.setOffText(get_content_switchbutton_name("page_management", "show_lottery_name", "disable"))
        self.show_lottery_name_button_switch.setOnText(get_content_switchbutton_name("page_management", "show_lottery_name", "enable"))
        ...
        self.reset_lottery_button_switch.setOffText(get_content_switchbutton_name("page_management", "reset_lottery", "disable"))
        self.reset_lottery_button_switch.setOnText(get_content_switchbutton_name("page_management", "reset_lottery", "enable"))
        ...
        self.lottery_quantity_control_switch.setOffText(get_content_switchbutton_name("page_management", "lottery_quantity_control", "disable"))
        self.lottery_quantity_control_switch.setOnText(get_content_switchbutton_name("page_management", "lottery_quantity_control", "enable"))
        ...
        self.lottery_start_button_switch.setOffText(get_content_switchbutton_name("page_management", "lottery_start_button", "disable"))
        self.lottery_start_button_switch.setOnText(get_content_switchbutton_name("page_management", "lottery_start_button", "enable"))
        ...
        self.lottery_list_combo_switch.setOffText(get_content_switchbutton_name("page_management", "lottery_list", "disable"))
        self.lottery_list_combo_switch.setOnText(get_content_switchbutton_name("page_management", "lottery_list", "enable"))
        ...
        self.lottery_quantity_label_switch.setOffText(get_content_switchbutton_name("page_management", "lottery_quantity_label", "disable"))
        self.lottery_quantity_label_switch.setOnText(get_content_switchbutton_name("page_management", "lottery_quantity_label", "enable"))
