...
class lottery_extraction_function(GroupHeaderCardWidget):
    def __init__(self, parent=None):
        ...
        self.draw_mode_combo.addItems(
            get_content_combo_name_async("lottery_settings", "draw_mode")
        )
        self.draw_mode_combo.setCurrentIndex(
            readme_settings_async("lottery_settings", "draw_mode")
        )
        ...
        self.clear_record_combo.setCurrentIndex(
            readme_settings_async("lottery_settings", "clear_record")
        )
        ...
        self.clear_time_spin.setValue(
            readme_settings_async("lottery_settings", "clear_time")
        )
        self.clear_time_spin.valueChanged.connect(
            lambda: update_settings(
                "lottery_settings", "clear_time", self.clear_time_spin.value()
            )
        )
        ...
        self.draw_type_combo.addItems(
            get_content_combo_name_async("lottery_settings", "draw_type")
        )
        self.draw_type_combo.setCurrentIndex(
            readme_settings_async("lottery_settings", "draw_type")
        )
        ...
        self.addGroup(
            ...
            get_content_name_async("lottery_settings", "clear_time"),
            get_content_description_async("lottery_settings", "clear_time"),
...
class lottery_music_settings(GroupHeaderCardWidget):
    def __init__(self, parent=None):
        ...
        self.animation_music_switch.setOffText(
            get_content_switchbutton_name_async(
                "lottery_settings", "animation_music", "disable"
            )
        )
        self.animation_music_switch.setOnText(
            get_content_switchbutton_name_async(
                "lottery_settings", "animation_music", "enable"
            )
        )
        self.animation_music_switch.setChecked(
            readme_settings_async("lottery_settings", "animation_music")
        )
        ...
        self.result_music_switch.setOffText(
            get_content_switchbutton_name_async(
                "lottery_settings", "result_music", "disable"
            )
        )
        self.result_music_switch.setOnText(
            get_content_switchbutton_name_async(
                "lottery_settings", "result_music", "enable"
            )
        )
        self.result_music_switch.setChecked(
            readme_settings_async("lottery_settings", "result_music")
        )
        self.result_music_switch.checkedChanged.connect(
            lambda: update_settings(
                "lottery_settings", "result_music", self.result_music_switch.isChecked()
            )
        )

        # 动画音乐文件夹按钮
        self.open_animation_music_folder_button = PushButton(
            get_content_name_async("lottery_settings", "open_animation_music_folder")
        )
        ...
        self.open_result_music_folder_button = PushButton(
            get_content_name_async("lottery_settings", "open_result_music_folder")
        )
        ...
        self.animation_music_volume_spin.setValue(
            readme_settings_async("lottery_settings", "animation_music_volume")
        )
        ...
        self.result_music_volume_spin.setValue(
            readme_settings_async("lottery_settings", "result_music_volume")
        )
        ...
        self.animation_music_fade_in_spin.setValue(
            readme_settings_async("lottery_settings", "animation_music_fade_in")
        )
        ...
        self.result_music_fade_in_spin.setValue(
            readme_settings_async("lottery_settings", "result_music_fade_in")
        )
        ...
        self.animation_music_fade_out_spin.setValue(
            readme_settings_async("lottery_settings", "animation_music_fade_out")
        )
        ...
        self.result_music_fade_out_spin.setValue(
            readme_settings_async("lottery_settings", "result_music_fade_out")
        )
        ...
        self.addGroup(
            ...
            get_content_name_async("lottery_settings", "animation_music"),
            get_content_description_async("lottery_settings", "animation_music"),
            self.animation_music_switch,
        )
        self.addGroup(
            get_theme_icon("ic_fluent_music_note_2_20_filled"),
            get_content_name_async("lottery_settings", "result_music"),
            get_content_description_async("lottery_settings", "result_music"),
        ...
        self.addGroup(
            ...
            get_content_name_async("lottery_settings", "open_animation_music_folder"),
            get_content_description_async(
                "lottery_settings", "open_animation_music_folder"
            ),
        ...
        self.addGroup(
            ...
            get_content_name_async("lottery_settings", "open_result_music_folder"),
            get_content_description_async(
                "lottery_settings", "open_result_music_folder"
            ),
            self.open_result_music_folder_button,
        )
        self.addGroup(
            get_theme_icon("ic_fluent_speaker_2_20_filled"),
            get_content_name_async("lottery_settings", "animation_music_volume"),
            get_content_description_async("lottery_settings", "animation_music_volume"),
            self.animation_music_volume_spin,
        )
        self.addGroup(
            get_theme_icon("ic_fluent_speaker_2_20_filled"),
            get_content_name_async("lottery_settings", "result_music_volume"),
            get_content_description_async("lottery_settings", "result_music_volume"),
            self.result_music_volume_spin,
        )
        self.addGroup(
            get_theme_icon("ic_fluent_arrow_up_20_filled"),
            get_content_name_async("lottery_settings", "animation_music_fade_in"),
            get_content_description_async(
                "lottery_settings", "animation_music_fade_in"
            ),
            self.animation_music_fade_in_spin,
        )
        self.addGroup(
            get_theme_icon("ic_fluent_arrow_up_20_filled"),
            get_content_name_async("lottery_settings", "result_music_fade_in"),
            get_content_description_async("lottery_settings", "result_music_fade_in"),
            self.result_music_fade_in_spin,
        )
        self.addGroup(
            get_theme_icon("ic_fluent_arrow_down_20_filled"),
            get_content_name_async("lottery_settings", "animation_music_fade_out"),
            get_content_description_async(
                "lottery_settings", "animation_music_fade_out"
            ),
            self.animation_music_fade_out_spin,
        )
        self.addGroup(
            get_theme_icon("ic_fluent_arrow_down_20_filled"),
            get_content_name_async("lottery_settings", "result_music_fade_out"),
            get_content_description_async("lottery_settings", "result_music_fade_out"),
