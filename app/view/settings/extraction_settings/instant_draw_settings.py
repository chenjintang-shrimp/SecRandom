...
class instant_draw_extraction_function(GroupHeaderCardWidget):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setTitle(get_setting_name("instant_draw_settings", "extraction_function"))
        self.setBorderRadius(8)

        # 抽取模式下拉框
        self.draw_mode_combo = ComboBox()
        self.draw_mode_combo.addItems(get_setting_combo_name("instant_draw_settings", "draw_mode"))
        self.draw_mode_combo.setCurrentIndex(readme_settings("instant_draw_settings", "draw_mode"))
        ...
        self.clear_record_combo.addItems(get_setting_combo_name("instant_draw_settings", "clear_record"))
        self.clear_record_combo.setCurrentIndex(readme_settings("instant_draw_settings", "clear_record"))
        ...
        self.draw_type_combo.addItems(get_setting_combo_name("instant_draw_settings", "draw_type"))
        self.draw_type_combo.setCurrentIndex(readme_settings("instant_draw_settings", "draw_type"))
        ...
        self.addGroup(get_theme_icon("ic_fluent_document_bullet_list_cube_20_filled"),
                        get_setting_name("instant_draw_settings", "draw_mode"), get_setting_description("instant_draw_settings", "draw_mode"), self.draw_mode_combo)
        self.addGroup(get_theme_icon("ic_fluent_text_clear_formatting_20_filled"),
                        get_setting_name("instant_draw_settings", "clear_record"), get_setting_description("instant_draw_settings", "clear_record"), self.clear_record_combo)
        self.addGroup(get_theme_icon("ic_fluent_clipboard_bullet_list_20_filled"),
                        get_setting_name("instant_draw_settings", "half_repeat"), get_setting_description("instant_draw_settings", "half_repeat"), self.half_repeat_spin)
        self.addGroup(get_theme_icon("ic_fluent_timer_off_20_filled"),
                        get_setting_name("instant_draw_settings", "clear_time"), get_setting_description("instant_draw_settings", "clear_time"), self.clear_time_spin)
        self.addGroup(get_theme_icon("ic_fluent_drawer_add_20_filled"),
                        get_setting_name("instant_draw_settings", "draw_type"), get_setting_description("instant_draw_settings", "draw_type"), self.draw_type_combo)
    ...
    def on_draw_mode_changed(self):
        ...
        if draw_mode_index == 0:  # 重复抽取模式
            ...
            self.clear_record_combo.addItems(get_any_position_value("instant_draw_settings", "clear_record", Language, "combo_items_other"))
            # 强制设置为"无需清除"（索引2）
...
class instant_draw_display_settings(GroupHeaderCardWidget):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setTitle(get_setting_name("instant_draw_settings", "display_settings"))
        self.setBorderRadius(8)
        ...
        self.display_format_combo.addItems(get_setting_combo_name("instant_draw_settings", "display_format"))
        self.display_format_combo.setCurrentIndex(readme_settings("instant_draw_settings", "display_format"))
        ...
        self.show_random_format_combo.addItems(get_setting_combo_name("instant_draw_settings", "show_random"))
        self.show_random_format_combo.setCurrentIndex(readme_settings("instant_draw_settings", "show_random"))
        ...
        self.addGroup(get_theme_icon("ic_fluent_text_font_20_filled"),
                        get_setting_name("instant_draw_settings", "font_size"), get_setting_description("instant_draw_settings", "font_size"), self.font_size_spin)
        self.addGroup(get_theme_icon("ic_fluent_slide_text_sparkle_20_filled"),
                        get_setting_name("instant_draw_settings", "display_format"), get_setting_description("instant_draw_settings", "display_format"), self.display_format_combo)
        self.addGroup(get_theme_icon("ic_fluent_group_list_20_filled"),
                        get_setting_name("instant_draw_settings", "show_random"), get_setting_description("instant_draw_settings", "show_random"), self.show_random_format_combo)
...
class instant_draw_basic_animation_settings(GroupHeaderCardWidget):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setTitle(get_setting_name("instant_draw_settings", "basic_animation_settings"))
        self.setBorderRadius(8)

        # 动画模式下拉框
        self.animation_combo = ComboBox()
        self.animation_combo.addItems(get_setting_combo_name("instant_draw_settings", "animation"))
        self.animation_combo.setCurrentIndex(readme_settings("instant_draw_settings", "animation"))
        ...
        self.addGroup(get_theme_icon("ic_fluent_sanitize_20_filled"),
                        get_setting_name("instant_draw_settings", "animation"), get_setting_description("instant_draw_settings", "animation"), self.animation_combo)
        self.addGroup(get_theme_icon("ic_fluent_timeline_20_filled"),
                        get_setting_name("instant_draw_settings", "animation_interval"), get_setting_description("instant_draw_settings", "animation_interval"), self.animation_interval_spin)
        self.addGroup(get_theme_icon("ic_fluent_slide_play_20_filled"),
                        get_setting_name("instant_draw_settings", "autoplay_count"), get_setting_description("instant_draw_settings", "autoplay_count"), self.autoplay_count_spin)


class instant_draw_color_theme_settings(GroupHeaderCardWidget):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setTitle(get_setting_name("instant_draw_settings", "color_theme_settings"))
        self.setBorderRadius(8)

        # 动画颜色主题下拉框
        self.animation_color_theme_combo = ComboBox()
        self.animation_color_theme_combo.addItems(get_setting_combo_name("instant_draw_settings", "animation_color_theme"))
        self.animation_color_theme_combo.setCurrentIndex(readme_settings("instant_draw_settings", "animation_color_theme"))
        ...
        self.result_color_theme_combo.addItems(get_setting_combo_name("instant_draw_settings", "result_color_theme"))
        self.result_color_theme_combo.setCurrentIndex(readme_settings("instant_draw_settings", "result_color_theme"))
        ...
        self.addGroup(get_theme_icon("ic_fluent_color_20_filled"),
                        get_setting_name("instant_draw_settings", "animation_color_theme"), get_setting_description("instant_draw_settings", "animation_color_theme"), self.animation_color_theme_combo)
        self.addGroup(get_theme_icon("ic_fluent_color_20_filled"),
                        get_setting_name("instant_draw_settings", "result_color_theme"), get_setting_description("instant_draw_settings", "result_color_theme"), self.result_color_theme_combo)

        self.animationColorCard = ColorSettingCard(
            self.animation_fixed_color_button,
            get_theme_icon("ic_fluent_text_color_20_filled"),
            self.tr(get_setting_name("instant_draw_settings", "animation_fixed_color")),
            self.tr(get_setting_description("instant_draw_settings", "animation_fixed_color")),
            self
        )
        self.resultColorCard = ColorSettingCard(
            self.result_fixed_color_button,
            get_theme_icon("ic_fluent_text_color_20_filled"),
            self.tr(get_setting_name("instant_draw_settings", "result_fixed_color")),
            self.tr(get_setting_description("instant_draw_settings", "result_fixed_color")),
            self
        )
...
class instant_draw_student_image_settings(GroupHeaderCardWidget):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setTitle(get_setting_name("instant_draw_settings", "student_image_settings"))
        self.setBorderRadius(8)

        # 学生图片开关
        self.student_image_switch = SwitchButton()
        self.student_image_switch.setOffText(get_setting_switchbutton_name("instant_draw_settings", "student_image", "disable"))
        self.student_image_switch.setOnText(get_setting_switchbutton_name("instant_draw_settings", "student_image", "enable"))
        self.student_image_switch.setChecked(readme_settings("instant_draw_settings", "student_image"))
        ...
        # 打开学生图片文件夹按钮
        self.open_student_image_folder_button = PushButton(get_setting_name("instant_draw_settings", "open_student_image_folder"))
        ...
        self.addGroup(get_theme_icon("ic_fluent_image_circle_20_filled"),
                        get_setting_name("instant_draw_settings", "student_image"), get_setting_description("instant_draw_settings", "student_image"), self.student_image_switch)
        self.addGroup(get_theme_icon("ic_fluent_folder_open_20_filled"),
                        get_setting_name("instant_draw_settings", "open_student_image_folder"), get_setting_description("instant_draw_settings", "open_student_image_folder"), self.open_student_image_folder_button)
...
class instant_draw_music_settings(GroupHeaderCardWidget):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setTitle(get_setting_name("instant_draw_settings", "music_settings"))
        self.setBorderRadius(8)

        # 动画音乐开关
        self.animation_music_switch = SwitchButton()
        self.animation_music_switch.setOffText(get_setting_switchbutton_name("instant_draw_settings", "animation_music", "disable"))
        self.animation_music_switch.setOnText(get_setting_switchbutton_name("instant_draw_settings", "animation_music", "enable"))
        self.animation_music_switch.setChecked(readme_settings("instant_draw_settings", "animation_music"))
        ...
        self.result_music_switch.setOffText(get_setting_switchbutton_name("instant_draw_settings", "result_music", "disable"))
        self.result_music_switch.setOnText(get_setting_switchbutton_name("instant_draw_settings", "result_music", "enable"))
        self.result_music_switch.setChecked(readme_settings("instant_draw_settings", "result_music"))
        ...
        # 动画音乐文件夹按钮
        self.open_animation_music_folder_button = PushButton(get_setting_name("instant_draw_settings", "open_animation_music_folder"))
        ...
        # 结果音乐文件夹按钮
        self.open_result_music_folder_button = PushButton(get_setting_name("instant_draw_settings", "open_result_music_folder"))
        ...
        self.addGroup(get_theme_icon("ic_fluent_music_note_2_20_filled"),
                        get_setting_name("instant_draw_settings", "animation_music"), get_setting_description("instant_draw_settings", "animation_music"), self.animation_music_switch)
        self.addGroup(get_theme_icon("ic_fluent_music_note_2_20_filled"),
                        get_setting_name("instant_draw_settings", "result_music"), get_setting_description("instant_draw_settings", "result_music"), self.result_music_switch)
        self.addGroup(get_theme_icon("ic_fluent_folder_open_20_filled"),
                        get_setting_name("instant_draw_settings", "open_animation_music_folder"), get_setting_description("instant_draw_settings", "open_animation_music_folder"), self.open_animation_music_folder_button)
        self.addGroup(get_theme_icon("ic_fluent_folder_open_20_filled"),
                        get_setting_name("instant_draw_settings", "open_result_music_folder"), get_setting_description("instant_draw_settings", "open_result_music_folder"), self.open_result_music_folder_button)
        self.addGroup(get_theme_icon("ic_fluent_speaker_2_20_filled"),
                        get_setting_name("instant_draw_settings", "animation_music_volume"), get_setting_description("instant_draw_settings", "animation_music_volume"), self.animation_music_volume_spin)
        self.addGroup(get_theme_icon("ic_fluent_speaker_2_20_filled"),
                        get_setting_name("instant_draw_settings", "result_music_volume"), get_setting_description("instant_draw_settings", "result_music_volume"), self.result_music_volume_spin)
        self.addGroup(get_theme_icon("ic_fluent_arrow_up_20_filled"),
                        get_setting_name("instant_draw_settings", "animation_music_fade_in"), get_setting_description("instant_draw_settings", "animation_music_fade_in"), self.animation_music_fade_in_spin)
        self.addGroup(get_theme_icon("ic_fluent_arrow_up_20_filled"),
                        get_setting_name("instant_draw_settings", "result_music_fade_in"), get_setting_description("instant_draw_settings", "result_music_fade_in"), self.result_music_fade_in_spin)
        self.addGroup(get_theme_icon("ic_fluent_arrow_down_20_filled"),
                        get_setting_name("instant_draw_settings", "animation_music_fade_out"), get_setting_description("instant_draw_settings", "animation_music_fade_out"), self.animation_music_fade_out_spin)
        self.addGroup(get_theme_icon("ic_fluent_arrow_down_20_filled"),
                        get_setting_name("instant_draw_settings", "result_music_fade_out"), get_setting_description("instant_draw_settings", "result_music_fade_out"), self.result_music_fade_out_spin)
