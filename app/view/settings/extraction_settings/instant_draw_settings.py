...
class instant_draw_music_settings(GroupHeaderCardWidget):
    def __init__(self, parent=None):
        ...
        self.animation_music_switch.setOffText(
            get_content_switchbutton_name_async(
                "instant_draw_settings", "animation_music", "disable"
            )
        )
        self.animation_music_switch.setOnText(
            get_content_switchbutton_name_async(
                "instant_draw_settings", "animation_music", "enable"
            )
        )
        self.animation_music_switch.setChecked(
            readme_settings_async("instant_draw_settings", "animation_music")
        )
        ...
        self.result_music_switch.setOffText(
            get_content_switchbutton_name_async(
                "instant_draw_settings", "result_music", "disable"
            )
        )
        self.result_music_switch.setOnText(
            get_content_switchbutton_name_async(
                "instant_draw_settings", "result_music", "enable"
            )
        )
        self.result_music_switch.setChecked(
            readme_settings_async("instant_draw_settings", "result_music")
        )
        ...
        self.open_animation_music_folder_button = PushButton(
            get_content_name_async(
                "instant_draw_settings", "open_animation_music_folder"
            )
        )
        ...
        self.open_result_music_folder_button = PushButton(
            get_content_name_async("instant_draw_settings", "open_result_music_folder")
        )
        ...
        self.animation_music_volume_spin.setValue(
            readme_settings_async("instant_draw_settings", "animation_music_volume")
        )
        ...
        self.result_music_volume_spin.setValue(
            readme_settings_async("instant_draw_settings", "result_music_volume")
        )
        ...
        self.animation_music_fade_in_spin.setValue(
            readme_settings_async("instant_draw_settings", "animation_music_fade_in")
        )
        ...
        self.result_music_fade_in_spin.setValue(
            readme_settings_async("instant_draw_settings", "result_music_fade_in")
        )
        ...
        self.animation_music_fade_out_spin.setValue(
            readme_settings_async("instant_draw_settings", "animation_music_fade_out")
        )
        ...
        self.result_music_fade_out_spin.setValue(
            readme_settings_async("instant_draw_settings", "result_music_fade_out")
        )
        ...
        self.addGroup(
            ...
            get_content_name_async("instant_draw_settings", "animation_music"),
            get_content_description_async("instant_draw_settings", "animation_music"),
            self.animation_music_switch,
        )
        self.addGroup(
            get_theme_icon("ic_fluent_music_note_2_20_filled"),
            get_content_name_async("instant_draw_settings", "result_music"),
            get_content_description_async("instant_draw_settings", "result_music"),
        ...
        self.addGroup(
            ...
            get_content_name_async("instant_draw_settings", "open_result_music_folder"),
            get_content_description_async(
                "instant_draw_settings", "open_result_music_folder"
            ),
            self.open_result_music_folder_button,
        )
        self.addGroup(
            get_theme_icon("ic_fluent_speaker_2_20_filled"),
            get_content_name_async("instant_draw_settings", "animation_music_volume"),
            get_content_description_async(
                "instant_draw_settings", "animation_music_volume"
            ),
            self.animation_music_volume_spin,
        )
        self.addGroup(
            get_theme_icon("ic_fluent_speaker_2_20_filled"),
            get_content_name_async("instant_draw_settings", "result_music_volume"),
            get_content_description_async(
                "instant_draw_settings", "result_music_volume"
            ),
            self.result_music_volume_spin,
        )
        self.addGroup(
            get_theme_icon("ic_fluent_arrow_up_20_filled"),
            get_content_name_async("instant_draw_settings", "animation_music_fade_in"),
            get_content_description_async(
                "instant_draw_settings", "animation_music_fade_in"
            ),
            self.animation_music_fade_in_spin,
        )
        self.addGroup(
            get_theme_icon("ic_fluent_arrow_up_20_filled"),
            get_content_name_async("instant_draw_settings", "result_music_fade_in"),
            get_content_description_async(
                "instant_draw_settings", "result_music_fade_in"
            ),
            self.result_music_fade_in_spin,
        )
        self.addGroup(
            get_theme_icon("ic_fluent_arrow_down_20_filled"),
            get_content_name_async("instant_draw_settings", "animation_music_fade_out"),
            get_content_description_async(
                "instant_draw_settings", "animation_music_fade_out"
            ),
            self.animation_music_fade_out_spin,
        )
        self.addGroup(
            get_theme_icon("ic_fluent_arrow_down_20_filled"),
            get_content_name_async("instant_draw_settings", "result_music_fade_out"),
            get_content_description_async(
                "instant_draw_settings", "result_music_fade_out"
            ),
