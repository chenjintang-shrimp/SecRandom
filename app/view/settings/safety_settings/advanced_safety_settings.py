...
class advanced_safety_strong_protection(GroupHeaderCardWidget):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setTitle(get_content_name("advanced_safety_settings", "strong_protection"))
        self.setBorderRadius(8)

        # 是否启动软件自我保护功能开关
        self.encryption_strong_switch = SwitchButton()
        self.encryption_strong_switch.setOffText(get_content_switchbutton_name("advanced_safety_settings", "encryption_strong_switch", "disable"))
        self.encryption_strong_switch.setOnText(get_content_switchbutton_name("advanced_safety_settings", "encryption_strong_switch", "enable"))
        ...
        self.encryption_strong_mode_combo.addItems(get_content_combo_name("advanced_safety_settings", "encryption_strong_mode"))
...
class advanced_safety_data_encryption(GroupHeaderCardWidget):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setTitle(get_content_name("advanced_safety_settings", "data_encryption"))
        self.setBorderRadius(8)

        # 是否开启名单加密开关
        self.encryption_list_switch = SwitchButton()
        self.encryption_list_switch.setOffText(get_content_switchbutton_name("advanced_safety_settings", "encryption_list_switch", "disable"))
        self.encryption_list_switch.setOnText(get_content_switchbutton_name("advanced_safety_settings", "encryption_list_switch", "enable"))
        ...
        self.encryption_history_switch.setOffText(get_content_switchbutton_name("advanced_safety_settings", "encryption_history_switch", "disable"))
        self.encryption_history_switch.setOnText(get_content_switchbutton_name("advanced_safety_settings", "encryption_history_switch", "enable"))
        ...
        self.encryption_temp_switch.setOffText(get_content_switchbutton_name("advanced_safety_settings", "encryption_temp_switch", "disable"))
        self.encryption_temp_switch.setOnText(get_content_switchbutton_name("advanced_safety_settings", "encryption_temp_switch", "enable"))
        ...
        self.addGroup(get_theme_icon("ic_fluent_document_bullet_list_clock_20_filled"), 
                        get_content_name("advanced_safety_settings", "encryption_list_switch"), get_content_description("advanced_safety_settings", "encryption_list_switch"), self.encryption_list_switch)
        self.addGroup(get_theme_icon("ic_fluent_document_data_lock_20_filled"), 
                        get_content_name("advanced_safety_settings", "encryption_history_switch"), get_content_description("advanced_safety_settings", "encryption_history_switch"), self.encryption_history_switch)
        self.addGroup(get_theme_icon("ic_fluent_document_lock_20_filled"), 
                        get_content_name("advanced_safety_settings", "encryption_temp_switch"), get_content_description("advanced_safety_settings", "encryption_temp_switch"), self.encryption_temp_switch)
