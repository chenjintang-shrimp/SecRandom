...
class contributor_page(QWidget):
    ...
    def _standardize_role_text(self, contributors):
        ...
        for contributor in contributors:
            ...
            text_rect = fm.boundingRect(QRect(0, 0, CONTRIBUTOR_MAX_ROLE_WIDTH, 0), 
                                       Qt.TextFlag.TextWordWrap, role_text)
    ...
    def update_layout(self):
        ...
        for i, card in enumerate(self.cards):
            ...
            card.setMaximumWidth(CONTRIBUTOR_CARD_MIN_WIDTH * 1.5)  # 设置最大宽度，防止卡片过宽
    ...
    def addContributorCard(self, contributor):
        ...
        try:
            ...
            cardLayout.setContentsMargins(CONTRIBUTOR_CARD_MARGIN, CONTRIBUTOR_CARD_MARGIN, 
                                        CONTRIBUTOR_CARD_MARGIN, CONTRIBUTOR_CARD_MARGIN)
