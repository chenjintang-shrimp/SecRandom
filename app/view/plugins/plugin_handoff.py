...
class PluginHandoffWindow(QFrame):
    def __init__(self, parent: QFrame = None):
        ...
        # 添加子页面
        self.addSubInterface(self.plugin_management_page, 'plugin_management', '插件管理-预览版')
        self.addSubInterface(self.plugin_market_page, 'plugin_market', '插件广场-预览版')
        self.addSubInterface(self.plugin_settings_page, 'plugin_settings', '插件设置-预览版')
