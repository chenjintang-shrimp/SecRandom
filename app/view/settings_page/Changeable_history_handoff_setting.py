...
from app.view.settings_page.Changeable_history_reward import changeable_history_reward

class changeable_history_handoff_setting(QFrame):
    ...
    def load_all_data(self):
        ...
        if self.pumping_reward_created:
            self.personal_setting_card.load_data()
    ...
    def create_pumping_people_card(self):
        ...
        self.pumping_people_card = changeable_history(load_on_init=False)
    ...
    def create_pumping_reward_card(self):
        ...
        self.personal_setting_card = changeable_history_reward(load_on_init=False)
        self.pumping_reward_inner_layout_personal.addWidget(self.personal_setting_card)
